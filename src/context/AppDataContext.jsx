...
export function AppDataProvider({ userId, children }) {
  ...
  const value = {
    ...
    inboundReceipts: toArray(inboundShipmentsState.receipts),
    inboundReceiptLines: toArray(inboundShipmentsState.receiptLines),
    inboundScheduleChanges: toArray(inboundShipmentsState.scheduleChanges),
    ...
    addInboundReceipt: inboundShipmentsState.addInboundReceipt,
    addInboundReceiptLine: inboundShipmentsState.addInboundReceiptLine,
    addInboundScheduleChange: inboundShipmentsState.addInboundScheduleChange,
    addSupplierProductAlias: inboundShipmentsState.addSupplierProductAlias,
    updateInboundSchedule: inboundShipmentsState.updateInboundSchedule,
    ...
    salesOrderSyncState: salesOrdersState.syncState,
    salesOrderSyncError: salesOrdersState.syncError,
    salesOrderLegacyLocalDataWarning: salesOrdersState.legacyLocalDataWarning,
    ...
    reloadEvents: eventsState.reload,
